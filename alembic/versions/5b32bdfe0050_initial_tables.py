...
Revision ID: 5b32bdfe0050
Revises: 
Create Date: 2025-06-30 18:20:20.668172
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_order_items_price_at_purchase'), 'order_items', ['price_at_purchase'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_order_items_price_at_purchase'), table_name='order_items')
